...
function [outEEG] = happe_muscIL(inEEG, pp, DIR)
...
pop_saveset(EEG_ICA, 'filename', convertStringsToChars(strcat(pp,'_wavclean.set')), ...
...
% TODO GISELA: either adapt the follwing, or take out
...
pop_saveset(outEEG, 'filename', convertStringsToChars(strcat(pp,'_muscILcleaned.set')), ...
    'filepath', convertStringsToChars(DIR.waveletCleaned));
