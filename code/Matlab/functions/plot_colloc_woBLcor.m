function plot_colloc_woBLcor(DIR,roi)
...
% Title, labels, legend
title(strcat('Collapsed localizer ACQ w/o BL corr')); 
...
exportgraphics(gcf, strcat(DIR.plotsCL, ...
    'ERP_Colloc_ACQ_all_woBLcorr_',roi,'.jpeg'), ...
    'Resolution', 300);
...
% Title, labels, legend
title(strcat('Collapsed localizer REC w/o BL corr')); 
subtitle(strjoin(ROI_labels, ' '));
xlabel('msec')
ylabel('µV')
...
% Save figure (for transparent figure, add 'BackgroundColor', 'none'
exportgraphics(gcf, strcat(DIR.plotsCL, ...
    strcat('ERP_Colloc_REC_all_woCLcorr_',roi,'.jpeg')), ...
    'Resolution', 300);
...
GA_dev_all = pop_mergeset(GA_dev12_fam, GA_dev3_fam);
GA_dev_all = pop_mergeset(GA_dev_all, GA_dev4_fam); 
...
GA_stan_all = pop_mergeset(GA_stan12_fam, GA_stan3_fam);
GA_stan_all = pop_mergeset(GA_stan_all, GA_stan4_fam); 
...
% Title, labels, legend
title(strcat('Collapsed localizer REC FAM w/o BL corr')); 
subtitle(strjoin(ROI_labels, ' '));
xlabel('msec')
ylabel('µV')
...
% Save figure (for transparent figure, add 'BackgroundColor', 'none'
exportgraphics(gcf, strcat(DIR.plotsCL, ...
    strcat('ERP_Colloc_RECFAM_all_woBLcorr_',roi,'.jpeg')), ...
    'Resolution', 300);
