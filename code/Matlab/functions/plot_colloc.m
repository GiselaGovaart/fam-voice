...
%% Per electrode to see whether to add F7 and F8

for j = 1:numel(GA_dev_all.chanlocs)
    if strcmp(GA_dev_all.chanlocs(j).labels, "V2")
        V2 = j;
    end
    if strcmp(GA_dev_all.chanlocs(j).labels, "Fp2")
        Fp2 = j;
    end
    if strcmp(GA_dev_all.chanlocs(j).labels, "F7")
        F7 = j;
    end
    if strcmp(GA_dev_all.chanlocs(j).labels, "F8")
        F8 = j;
    end
    if strcmp(GA_dev_all.chanlocs(j).labels, "F9")
        F9 = j;
    end
    if strcmp(GA_dev_all.chanlocs(j).labels, "F10")
        F10 = j;
    end
end
