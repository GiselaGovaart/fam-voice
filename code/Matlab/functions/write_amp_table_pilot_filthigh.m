function write_amp_table_pilot_filthigh(Subj, DIR, blvalue, twstartacq, twendacq, twstartrec, twendrec)
...
for ipp = 1:length(Subj)
    for iCond = 1:length(CondNr)
        ...
        if isfile(strcat(DIR.processed,setName))
            ...
            mean_amplitude_c4 + mean_amplitude_f7 + mean_amplitude_f8 + ...
            mean_amplitude_cz + mean_amplitude_c3)/10;
