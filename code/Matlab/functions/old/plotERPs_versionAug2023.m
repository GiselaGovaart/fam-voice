...
fig = figure;
h1 = plot(GA_dev12.times, ...
    ((DIFF_12(Fz,:,:)+DIFF_12(F3,:,:)+DIFF_12(F4,:,:))/3), ...
    'Color', 'black', 'Linewidth', 3, 'LineStyle',':');
hold on;
h2 = plot(GA_dev12.times, ...
    ((GA_dev12.data(Fz,:,:)+GA_dev12.data(F3,:,:)+GA_dev12.data(F4,:,:))/3), ...
    'Color', '#f78d95', 'Linewidth', 2);
hold on;
h3 = plot(GA_dev12.times, ...
    ((GA_stan12.data(Fz,:,:)+GA_stan12.data(F3,:,:)+GA_stan12.data(F4,:,:))/3), ...
    'Color', '#3b8dca', 'Linewidth', 2);
hold on;
...
fig = figure;
h1 = plot(GA_dev12.times, ...
    ((DIFF_12(Cz,:,:)+DIFF_12(C3,:,:)+DIFF_12(C4,:,:))/3), ...
    'Color', 'black', 'Linewidth', 3, 'LineStyle',':');
hold on;
h2 = plot(GA_dev12.times, ...
    ((GA_dev12.data(Cz,:,:)+GA_dev12.data(C3,:,:)+GA_dev12.data(C4,:,:))/3), ...
    'Color', '#f78d95', 'Linewidth', 2);
hold on;
h3 = plot(GA_dev12.times, ...
    ((GA_stan12.data(Cz,:,:)+GA_stan12.data(C3,:,:)+GA_stan12.data(C4,:,:))/3), ...
    'Color', '#3b8dca', 'Linewidth', 2);
hold on;
...
h1 = plot(GA_dev3.times, ...
    ((DIFF_3(Fz,:,:)+DIFF_3(F3,:,:)+DIFF_3(F4,:,:))/3), ...
    'Color', 'black', 'Linewidth', 3, 'LineStyle','--');
hold on;
h2 = plot(GA_dev3.times, ...
    ((GA_dev3.data(Fz,:,:)+GA_dev3.data(F3,:,:)+GA_dev3.data(F4,:,:))/3), ...
    'Color', '#f78d95', 'Linewidth', 2);
hold on;
h3 = plot(GA_dev3.times, ...
    ((GA_stan3.data(Fz,:,:)+GA_stan3.data(F3,:,:)+GA_stan3.data(F4,:,:))/3), ...
    'Color', '#3b8dca', 'Linewidth', 2);
hold on;
...
fig = figure;
h1 = plot(GA_dev3.times, ...
    ((DIFF_3(Cz,:,:)+DIFF_3(C3,:,:)+DIFF_3(C4,:,:))/3), ...
    'Color', 'black', 'Linewidth', 3, 'LineStyle','--');
hold on;
h2 = plot(GA_dev3.times, ...
    ((GA_dev3.data(Cz,:,:)+GA_dev3.data(C3,:,:)+GA_dev3.data(C4,:,:))/3), ...
    'Color', '#f78d95', 'Linewidth', 2);
hold on;
h3 = plot(GA_dev3.times, ...
    ((GA_stan3.data(Cz,:,:)+GA_stan3.data(C3,:,:)+GA_stan3.data(C4,:,:))/3), ...
    'Color', '#3b8dca', 'Linewidth', 2);
hold on;
...
h1 = plot(GA_dev4.times, ...
    ((DIFF_4(Fz,:,:)+DIFF_4(F3,:,:)+DIFF_4(F4,:,:))/3), ...
    'Color', 'black', 'Linewidth', 3, 'LineStyle','--');
hold on;
h2 = plot(GA_dev4.times, ...
    ((GA_dev4.data(Fz,:,:)+GA_dev4.data(F3,:,:)+GA_dev4.data(F4,:,:))/3), ...
    'Color', '#f78d95', 'Linewidth', 2);
hold on;
h3 = plot(GA_dev4.times, ...
    ((GA_stan4.data(Fz,:,:)+GA_stan4.data(F3,:,:)+GA_stan4.data(F4,:,:))/3), ...
    'Color', '#3b8dca', 'Linewidth', 2);
hold on;
...
fig = figure;
h1 = plot(GA_dev4.times, ...
    ((DIFF_4(Cz,:,:)+DIFF_4(C3,:,:)+DIFF_4(C4,:,:))/3), ...
    'Color', 'black', 'Linewidth', 2, 'LineStyle','--');
hold on;
h2 = plot(GA_dev4.times, ...
    ((GA_dev4.data(Cz,:,:)+GA_dev4.data(C3,:,:)+GA_dev4.data(C4,:,:))/3), ...
    'Color', '#f78d95', 'Linewidth', 1);
hold on;
h3 = plot(GA_dev4.times, ...
    ((GA_stan4.data(Cz,:,:)+GA_stan4.data(C3,:,:)+GA_stan4.data(C4,:,:))/3), ...
...
DIFF1 = DIFF_all; %difference across mean of all subjects
...
DIFF1 = DIFF_12; %difference across mean of all subjects
DIFF_T1 = DIFF1(:,sample1:sample2); % neue Matrix mit Werten von TIME1-TIME2 ms ( sample3 / sample4)
DIFF_TW1 = mean(DIFF_T1,2); % calculate average
...
DIFF1 = DIFF_3; % difference across mean of all subjects
DIFF_T1 = DIFF1(:,sample1:sample2); % neue Matrix mit Werten von TIME1-TIME2 ms ( sample3 / sample4)
DIFF_TW1 = mean(DIFF_T1,2); % calculate average
...
DIFF1 = DIFF_4; %difference across mean of all subjects
DIFF_T1 = DIFF1(:,sample1:sample2); % neue Matrix mit Werten von TIME1-TIME2 ms ( sample3 / sample4)
DIFF_TW1 = mean(DIFF_T1,2); % calculate average
