function computeGA_raw(DIR, Subj_Fam, Subj_Unfam)
...
DIR.processed_raw = convertStringsToChars(DIR.processed_raw);
DIR.grandaverage_raw = convertStringsToChars(DIR.grandaverage_raw);


%% Make GA for training speaker (1 or 2)
% For FAM------------------------------------------------------------------
Subj = Subj_Fam;
cd(DIR.processed_raw)
counter = 1;
GAargD = cell(counter);
...
for ipp = 1:length(Subj)
    ...
    if isfile(strcat(DIR.processed_raw,setNameD1))
    setNameD = setNameD1;
    elseif isfile(strcat(DIR.processed_raw,setNameD2))
    setNameD = setNameD2;
    else
        setNameD = 0;
    end
    ...
    if isfile(strcat(DIR.processed_raw,setNameS11))
    setNameS1 = setNameS11;
    elseif isfile(strcat(DIR.processed_raw,setNameS12))
    ...
    if isfile(strcat(DIR.processed_raw,setNameS21))
    setNameS2 = setNameS21;
    elseif isfile(strcat(DIR.processed_raw,setNameS22))
    ...
    if isfile(strcat(DIR.processed_raw,setNameD))
        setD = pop_loadset(convertStringsToChars(setNameD));
        trialsD = setD.trials;
    end
    if isfile(strcat(DIR.processed_raw,setNameS1))
        setS1 = pop_loadset(convertStringsToChars(setNameS1));
        trialsS1 = setS1.trials;
    end
    if isfile(strcat(DIR.processed_raw,setNameS2))
        setS2 = pop_loadset(convertStringsToChars(setNameS2));
        trialsS2 = setS2.trials;
    end

    if isfile(strcat(DIR.processed_raw,setNameS1)) && isfile(strcat(DIR.processed_raw,setNameS2))
...
% Deviants
ga_1012 = pop_grandaverage(GAargD, 'pathname', DIR.processed_raw);
% S1
ga_2212 = pop_grandaverage(GAargS1, 'pathname', DIR.processed_raw);
% S2
ga_2312 = pop_grandaverage(GAargS2, 'pathname', DIR.processed_raw);

GA_merged = pop_mergeset(ga_2212, ga_2312);
pop_saveset(GA_merged, 'filename', 'ga_fam_S12_Stan.set', ...
        'filepath', DIR.grandaverage_raw );
...
% Deviants
ga_103 = pop_grandaverage(GAargD, 'pathname', DIR.processed_raw);
% S1
ga_223 = pop_grandaverage(GAargS1, 'pathname', DIR.processed_raw);
% S2
ga_233 = pop_grandaverage(GAargS2, 'pathname', DIR.processed_raw);
...
% Deviants
ga_104 = pop_grandaverage(GAargD, 'pathname', DIR.processed_raw);
% S1
ga_224 = pop_grandaverage(GAargS1, 'pathname', DIR.processed_raw);
% S2
ga_234 = pop_grandaverage(GAargS2, 'pathname', DIR.processed_raw);
