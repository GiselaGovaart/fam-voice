...
# Print the plot
plot(p)
png(file=here("data", "sensitivity_analysis", "A1_plotpriors.png"),
...
m_orig  <- brm(MMR ~ 1 + TestSpeaker * Group +
                      ...
                      cores = num_chains,
                      seed = project_seed,
                      file = here("data", "model_output", "A1_model_sensitivity_acq.rds"),
...
m_alt_1 <- brm(MMR ~ 1 + TestSpeaker * Group +
               ...
               cores = num_chains,
               seed = project_seed,
               file = here("data", "model_output", "A1_model_sensitivity_altern1_acq.rds"),
               file_refit = "on_change",
               save_pars = save_pars(all = TRUE)
)
...
m_alt_2 <- brm(MMR ~ 1 + TestSpeaker * Group +
               ...
               cores = num_chains,
               seed = project_seed,
               file = here("data", "model_output", "A1_model_sensitivity_altern2_acq.rds"),
               file_refit = "on_change",
               save_pars = save_pars(all = TRUE)
)
...
m_alt_3 <- brm(MMR ~ 1 + TestSpeaker * Group +
               ...
               cores = num_chains,
               seed = project_seed,
               file = here("data", "model_output", "A1_model_sensitivity_altern3_acq.rds"),
               file_refit = "on_change",
               save_pars = save_pars(all = TRUE)
)
...
summary(m_orig) # Rhat of max 1.00. ESS a bit low for sigma. 85 divergent transitions
summary(m_alt_1) # Rhat and ESS'es look good. 627 divergent transitions
summary(m_alt_2) # Rhat and ESS'es look good. 519 divergent transitions
summary(m_alt_3) # Rhat and ESS'es look good. 222 divergent transitions
...
plot(p)
png(file=here("data", "sensitivity_analysis", "A1_postDens_Intercept_differentPriors.png"),
    width=4500, height=3000,res=600)
plot(p)
dev.off()
...
plot(p)
png(file=here("data", "sensitivity_analysis", "A1_postDens_TestSpeaker_differentPriors.png"),
    width=4500, height=3000,res=600)
plot(p)
dev.off()
...
plot(p)
png(file=here("data", "sensitivity_analysis", "A1_postDens_Group_differentPriors.png"),
    width=4500, height=3000,res=600)
plot(p)
dev.off()
