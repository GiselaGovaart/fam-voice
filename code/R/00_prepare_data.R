...
# PILOT DATA ---------------------------------------------------------------------
# Read csv
t_a = read.delim(here("data", "amplitudes_pilot_acq.txt"), header = TRUE, sep = "\t", dec = ".")
t_r = read.delim(here("data", "amplitudes_pilot_rec.txt"), header = TRUE, sep = "\t", dec = ".")
...
# Save data
data_pilot_acq <- data_long
setwd(here("data"))
# do the following only once
# worcs:::write_worcsfile(".worcs")
open_data(data_pilot_acq, worcs_directory = ".")
setwd(here())
...
# Save data
data_pilot_rec <- data_long
setwd(here("data"))
# do the following only once
# worcs:::write_worcsfile(".worcs")
open_data(data_pilot_rec, worcs_directory = ".")
setwd(here())
