...
save(res, file="A5_sensAnal_simpleGroup-S1.rda")
...
res <- data.frame(prior_sd, BF, logBF=log10(BF))
save(res, file="A5_sensAnal_simpleGroup-S2.rda")
#load("05_modelcomparison.rda")
...
res <- data.frame(prior_sd, BF, logBF=log10(BF))
save(res, file="R5_sensAnal_unfam2-fam1.rda")
#load("R5_sensAnal_unfam2-fam1.rda)
