...
TestSpeakerEffect <- colMeans(pp[data_acq$TestSpeaker=="S1",]) - colMeans(pp[data_acq$TestSpeaker=="S4",])
hist(TestSpeakerEffect, breaks = 40)
# distribution of the effect of Group
GroupEffect <- colMeans(pp[data_acq$Group=="fam",]) - colMeans(pp[data_acq$Group=="unfam",])
