...
%% Create DIRs 
manualInfoFolder = "Analysis_Okt24_new";
...
%% For Segm -200 to 600 
manualInfoFolder = "Analysis_Okt24_segment600-real";
...
% Run preprocessing functions
for pp = Subj
    HAPPE_FamVoice_segm600(pp, DIR, blvalue, Subj_cbs, Subj_char)
end
...
%% FOR AMP 200
manualInfoFolder = "Analysis_Okt24_ampcrit200";
...
% without BLcorr
for pp = Subj
    save_sets_woBLcorr_amp200(pp, DIR)
end
computeGA_withoutBLcorr(DIR, Subj_Fam, Subj_Unfam);
plot_averagedData_woBLcor(DIR);
plot_ERP_proc_woBLcorr(DIR, twstartacq, twendacq, twstartrec, twendrec);
