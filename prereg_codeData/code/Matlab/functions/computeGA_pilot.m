function computeGA_pilot(Subj, DIR)
...
pop_saveset(GA_merged, 'filename', 'ga_S12_Stan.set', ...
        'filepath', DIR.grandaverage);
pop_saveset(ga_1012, 'filename', 'ga_S12_Dev.set', ...
        'filepath', DIR.grandaverage);
...
pop_saveset(GA_merged, 'filename', 'ga_S3_Stan.set', ...
        'filepath', DIR.grandaverage);
pop_saveset(ga_103, 'filename', 'ga_S3_Dev.set', ...
        'filepath', DIR.grandaverage);
...
pop_saveset(GA_merged, 'filename', 'ga_S4_Stan.set', ...
        'filepath', DIR.grandaverage);
pop_saveset(ga_104, 'filename', 'ga_S4_Dev.set', ...
        'filepath', DIR.grandaverage);
