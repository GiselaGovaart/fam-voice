# This script analyzes the mahalanobis distance (to the center of the distribution) of all the vowels in a dir, and then takes the 166 vowels that are closest to the center.
...
for dir from 1 to 2
	...
	if dir = 1
		selectObject: table_all
		Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_all_i_" + speaker$ + ".Table"
	else
		selectObject: table_all
		Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_all_e_" + speaker$ + ".Table"
	endif
	...
	if dir = 1
		selectObject: table_all
		Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_166_i_" + speaker$ + ".Table"
	else
		selectObject: table_all
		Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_166_e_" + speaker$ + ".Table"
	endif

endfor


## Combine the e and i tables

# ALL
;table_all_e = Read from file: "../Recordings/" + speaker$ + "/analyses/75_table_all_e_" + speaker$ + ".Table"
;table_all_i = Read from file: "../Recordings/" + speaker$ + "/analyses/75_table_all_i_" + speaker$ + ".Table"

;selectObject: table_all_e
;Append column: "vowel"
;nr_rows = Get number of rows
;for j from 1 to nr_rows
;	Set string value: j, "vowel", "e"
;endfor

;selectObject: table_all_i
;Append column: "vowel"
;nr_rows = Get number of rows
;for j from 1 to nr_rows
;	Set string value: j, "vowel", "i"
;endfor

;selectObject: table_all_e, table_all_i
;table_all_ei = Append
;selectObject: table_all_ei
;Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_all_ei_" + speaker$ + ".Table"

# 166 > 332
;table_166_e = Read from file: "../Recordings/" + speaker$ + "/analyses/75_table_166_e_" + speaker$ + ".Table"
;table_166_i = Read from file: "../Recordings/" + speaker$ + "/analyses/75_table_166_i_" + speaker$ + ".Table"

;selectObject: table_166_e
;Append column: "vowel"
;nr_rows = Get number of rows
;for j from 1 to nr_rows
;	Set string value: j, "vowel", "e"
...
;selectObject: table_166_e, table_166_i
;table_166_ei = Append
;selectObject: table_166_ei
;Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_332_ei_" + speaker$ + ".Table"
