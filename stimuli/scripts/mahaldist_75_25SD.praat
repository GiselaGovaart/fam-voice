...
for dir from 1 to 2
	...
	table_all = Extract rows where column (number): "mahal", "less than", 3


	if dir = 1
		selectObject: table_all
		Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_3SD_i_" + speaker$ + ".Table"
	else
		selectObject: table_all
		Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_3SD_e_" + speaker$ + ".Table"
	endif
...
# 1,5 SD combine
;table_15SD_e = Read from file: "../Recordings/" + speaker$ + "/analyses/75_table_15SD_e_" + speaker$ + ".Table"
;table_15SD_i = Read from file: "../Recordings/" + speaker$ + "/analyses/75_table_15SD_i_" + speaker$ + ".Table"

;selectObject: table_15SD_e
;Append column: "vowel"
;nr_rows = Get number of rows
;for j from 1 to nr_rows
;	Set string value: j, "vowel", "e"
...
;selectObject: table_15SD_e, table_15SD_i
;table_15SD_ei = Append
;selectObject: table_15SD_ei
;Save as tab-separated file: "../Recordings/" + speaker$ + "/analyses/75_table_15SD_ei_" + speaker$ + ".Table"
